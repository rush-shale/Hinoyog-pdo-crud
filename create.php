...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($product_name_err) && empty($product_details_err) && empty($product_retail_price_err)){
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            $stmt->bindParam(":product_retail_price", $param_product_retails_price);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="product_details" class="form-control <?php echo (!empty($address_err)) ? 'is-invalid' : ''; ?>"><?php echo $product_details; ?></textarea>
